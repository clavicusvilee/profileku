...
export default {
  metaInfo: {
    title: 'Contact',
    titleTemplate: "%s ← GaboonWare Contact",
    meta: [
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        name: "description",
        content:
          "GaboonWare Contact and Freelance Get in Touch ContactMe"
      },
      { charset: "utf-8" },
