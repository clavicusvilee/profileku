<template>
  <v-layout column justify-center align-center class="mt-4 pt-2">
    ...
    <vue-typer class="headline" :repeat="0" text="Clavicus Vile"></vue-typer>
    <vue-typer
      :text="text1"
      :repeat="Infinity"
      :shuffle="false"
      ...
      <v-card flat color="transparent" max-width="500">
        <v-card-title primary-title>
          <div>
            ...
            <div>
              <p>
                Hello! I’m Clavicus Vile. I'm a front-end developer who
                is passionate about
                <span
...
export default {
  metaInfo: {
    title: 'Home',
    titleTemplate: "%s ← GaboonWare",
    meta: [
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      { name: 'description', content: "GaboonWare" },
      { charset: 'utf-8' },
      { property: 'og:title', content: "GaboonWare" },
      { property: 'og:site_name', content: "GaboonWare" },
      { property: 'og:type', content: 'website' },
      { property: 'og:url', content: 'https://gaboonware.my.id/' },
      {
        property: 'og:image',
        content: 'https://i.imgur.com/Dcz2PGx.jpg'
      },
      { property: 'og:description', content: "GaboonWare" }
    ]
  },
  components: {
    'vue-typer': VueTyper,
  ...
  data () {
    return {
      icons: [
        { href: 'https://github.com/nandito-id', icon: 'fab fa-github' },
        {
          href: 'https://www.facebook.com/reza.doank.9465177',
          icon: 'fab fa-facebook-f'
        },
        { href: 'https://www.instagram.com/nandito_id/', icon: 'fab fa-instagram' }
      ],
